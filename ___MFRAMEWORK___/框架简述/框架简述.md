...
- <B>UI底层框架</B>
  - <B><GN>MVC</GN></B>---即<GN><B>Model-View-Controller</B></GN>，<VT>最经典的UI思想</VT>
  - <B><GN>MVVM</GN></B>---即<GN><B>Model-View-ViewModel</B></GN>，<VT>与MVC类似，对于大量动态UI会比MVC更高效</VT>
  - <B><GN>MVP</GN></B>---即<GN><B>Model-View-Presenter</B></GN>，<VT>与MVC类似，但是View与Model完全隔离</VT>
- <B><GN>ECS</GN></B>---即<GN><B>Entity Component System</B></GN>，<VT>是一个gameplay层面框架，用于解决GameObject的更新操作</VT>
  - Unity本身提供了Entities包，即ECS
  - <B><GN>DOTS</GN></B>，即<GN><B>Data-Oriented Technology Stack</B></GN>，<VT>由ECS/Job System/Burst组建而成</VT>
- <B>事件驱动</B>
  - C#的delegate/event与Action/Func
  - Unity的UnityEvent
  - 中介者模式
  - <B><GN>UniRx</GN></B>，Unity的<VT>响应式编程框架</VT>
- <B>数据驱动</B>
...
- <B><GN>分层架构</GN></B>，即<GN><B>Layered Architecture</B></GN>，大致就是通过分层使<VT>职责分离，耦合降低</VT>
  - <B>可能的分层形式：</B>
    - 表现层/逻辑层/数据层---最简单的形式
    - 表现层/逻辑层/服务层/领域层/数据层/基础设施层---扩展形式
- <B><GN>CQRS</GN></B>，即<GN><B>命令查询职责分离Command Query Responsibility Segregation</B></GN>
  核心就是<VT>将写入与读取分离</VT>
- <B><GN>DDD</GN></B>
...
- <B>GameFramework</B>
- <B>MyUnityFramework</B>
- <B>QTFramework(暂未下载)</B>
  - [配置方法](https://www.bilibili.com/video/BV138y6YDEG6)
- <B>LoxodonFramework</B>---UI解决方案
